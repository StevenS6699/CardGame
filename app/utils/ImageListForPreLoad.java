...
public class ImageListForPreLoad {
	...
	public static Set<String> getImageListForPreLoad() {
		...
		// Avatars
		images.addAll(BasicObjectBuilders.loadUnit(StaticConfFiles.humanAvatar, -1, Unit.class,null).getAnimations().getAllFrames());
		images.addAll(BasicObjectBuilders.loadUnit(StaticConfFiles.aiAvatar, -1, Unit.class,null).getAnimations().getAllFrames());
		...
		// Deck 1 Units
		images.addAll(BasicObjectBuilders.loadUnit(StaticConfFiles.u_comodo_charger, -1, Unit.class,null).getAnimations().getAllFrames());
		images.addAll(BasicObjectBuilders.loadUnit(StaticConfFiles.u_azure_herald, -1, Unit.class,null).getAnimations().getAllFrames());
		images.addAll(BasicObjectBuilders.loadUnit(StaticConfFiles.u_azurite_lion, -1, Unit.class,null).getAnimations().getAllFrames());
		images.addAll(BasicObjectBuilders.loadUnit(StaticConfFiles.u_fire_spitter, -1, Unit.class,null).getAnimations().getAllFrames());
		images.addAll(BasicObjectBuilders.loadUnit(StaticConfFiles.u_hailstone_golem, -1, Unit.class,null).getAnimations().getAllFrames());
		images.addAll(BasicObjectBuilders.loadUnit(StaticConfFiles.u_ironcliff_guardian, -1, Unit.class,null).getAnimations().getAllFrames());
		images.addAll(BasicObjectBuilders.loadUnit(StaticConfFiles.u_pureblade_enforcer, -1, Unit.class,null).getAnimations().getAllFrames());
		images.addAll(BasicObjectBuilders.loadUnit(StaticConfFiles.u_silverguard_knight, -1, Unit.class,null).getAnimations().getAllFrames());
		...
		// Deck 2 Units
		images.addAll(BasicObjectBuilders.loadUnit(StaticConfFiles.u_planar_scout, -1, Unit.class,null).getAnimations().getAllFrames());
		images.addAll(BasicObjectBuilders.loadUnit(StaticConfFiles.u_rock_pulveriser, -1, Unit.class,null).getAnimations().getAllFrames());
		images.addAll(BasicObjectBuilders.loadUnit(StaticConfFiles.u_pyromancer, -1, Unit.class,null).getAnimations().getAllFrames());
		images.addAll(BasicObjectBuilders.loadUnit(StaticConfFiles.u_bloodshard_golem, -1, Unit.class,null).getAnimations().getAllFrames());
		images.addAll(BasicObjectBuilders.loadUnit(StaticConfFiles.u_blaze_hound, -1, Unit.class,null).getAnimations().getAllFrames());
		images.addAll(BasicObjectBuilders.loadUnit(StaticConfFiles.u_windshrike, -1, Unit.class,null).getAnimations().getAllFrames());
		images.addAll(BasicObjectBuilders.loadUnit(StaticConfFiles.u_hailstone_golemR, -1, Unit.class,null).getAnimations().getAllFrames());
		images.addAll(BasicObjectBuilders.loadUnit(StaticConfFiles.u_serpenti, -1, Unit.class,null).getAnimations().getAllFrames());
	...
	public static List<String> getCardImagesForPreload(String configFile) {
		Card card = BasicObjectBuilders.loadCard(configFile, 0, Card.class, null);
